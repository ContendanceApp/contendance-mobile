...
PresenceHistoryStudents presenceHistoryStudentFromJson(String str) =>
    PresenceHistoryStudents.fromJson(json.decode(str));

String presenceHistoryStudentToJson(PresenceHistoryStudents data) =>
    json.encode(data.toJson());

class PresenceHistoryStudents {
  PresenceHistoryStudents({
    required this.data,
  });

  List<PresenceHistoryStudent> data;

  factory PresenceHistoryStudents.fromJson(Map<String, dynamic> json) =>
      PresenceHistoryStudents(
        data: List<PresenceHistoryStudent>.from(
            json["data"].map((x) => PresenceHistoryStudent.fromJson(x))),
      );
...
class PresenceHistoryStudent {
  PresenceHistoryStudent({
  ...
  factory PresenceHistoryStudent.fromJson(Map<String, dynamic> json) =>
      PresenceHistoryStudent(
