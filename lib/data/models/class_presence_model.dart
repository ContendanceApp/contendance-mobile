...
ClassPresenceModel classPresenceFromJson(String str) =>
    ClassPresenceModel.fromJson(json.decode(str));

String classPresenceToJson(ClassPresenceModel data) =>
    json.encode(data.toJson());

class ClassPresenceModel {
  ClassPresenceModel({
  ...
  factory ClassPresenceModel.fromJson(Map<String, dynamic> json) =>
      ClassPresenceModel(
